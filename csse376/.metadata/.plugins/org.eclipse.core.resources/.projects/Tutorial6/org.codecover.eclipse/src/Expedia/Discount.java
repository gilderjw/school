...
public class Discount {
  static {
    CodeCoverCoverageCounter$elhpz7zy7hnjmtcf5nq9.ping();
  }

	public Discount (double aReductionPercent, int aFrequentFlyerMilesCost)
	{
		CodeCoverCoverageCounter$elhpz7zy7hnjmtcf5nq9.statements[1]++;
ReductionPercent = aReductionPercent;
		CodeCoverCoverageCounter$elhpz7zy7hnjmtcf5nq9.statements[2]++;
...
class CodeCoverCoverageCounter$elhpz7zy7hnjmtcf5nq9 extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance("/home/gilderjw/Documents/csse376/.metadata/.plugins/org.eclipse.core.resources/.projects/Tutorial6/org.codecover.eclipse/coverage-logs/coverage-log-file.clf"), "61766ddc-b102-4a0f-8a08-24b5d03a50bd").addObservedContainer(new CodeCoverCoverageCounter$elhpz7zy7hnjmtcf5nq9 ());
  }
  ...
  public CodeCoverCoverageCounter$elhpz7zy7hnjmtcf5nq9 () {
    super("Expedia.Discount.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("Expedia.Discount.java");
      for (int i = 1; i <= 2; i++) {
        if (statements[i] != 0L) {
