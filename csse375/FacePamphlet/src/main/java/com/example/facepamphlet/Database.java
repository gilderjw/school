...
public class Database implements Serializable {
	...
	private static final long serialVersionUID = 124020843806515606L;
	...
	public boolean addSchool(String name) {
		return this.schools.add(name);
	}

	public boolean schoolExists(String name) {
		return this.schools.contains(name);
	}

	public boolean addWorkplace(String name) {
		return this.workplaces.add(name);
	}

	public boolean workplaceExists(String name) {
		return this.workplaces.contains(name);
	}
