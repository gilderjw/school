...
static void
init_sampler(int k, int maxsamples)
{
  if (values)
    free(values);
...
int
has_converged(int k_arg, double epsilon_arg, int maxsamples)
{
...
double
fcyc2_full(test_funct f, int param1, int param2, int clear_cache,
...
double
fcyc2(test_funct f, int param1, int param2, int clear_cache)
{
...
double
fcyc2_full_tod(test_funct f, int param1, int param2, int clear_cache,
               int k, double epsilon, int maxsamples, int compensate) 
{
  double result;
  init_sampler(k, maxsamples);
...
double
fcyc2_tod(test_funct f, int param1, int param2, int clear_cache)
{
